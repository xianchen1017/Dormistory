    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        >
                ...
                <el-form-item label="一号床位" class="item">
                  <template #default="scope">
                    ...
                    <div class="el-form--inline-icon">
                      <el-icon
                        v-if="props.row.firstBed == null"
                        @click="plusIcon(1, props.row)"
                      >
                        <plus />
                      </el-icon>
                      <div
                        v-if="props.row.firstBed != null"
                        class="el-form--inline-icon"
                      >
                        ...
                        <el-popconfirm
                          title="确认删除？"
                          @confirm="deleteStuBed(1, props.row)"
                        >
                          <template #reference>
                            <el-icon>
                              <delete />
                  ...
                  <template #default="scope">
                    ...
                    <div class="el-form--inline-icon">
                      ...
                      >
                        ...
                        <el-popconfirm
                          title="确认删除？"
                          @confirm="deleteStuBed(2, props.row)"
                        >
                          <template #reference>
                            <el-icon>
                              <delete />
                  ...
                  <template #default="scope">
                    ...
                    <div class="el-form--inline-icon">
                      ...
                      >
                        ...
                        <el-popconfirm
                          title="确认删除？"
                          @confirm="deleteStuBed(3, props.row)"
                        >
                          <template #reference>
                            <el-icon>
                              <delete />
                  ...
                  <template #default="scope">
                    ...
                    <div class="el-form--inline-icon">
                      ...
                      >
                        ...
                        <el-popconfirm
                          title="确认删除？"
                          @confirm="deleteStuBed(4, props.row)"
                        >
                          <template #reference>
                            <el-icon>
                              <delete />
          ...
          />
          <!-- 新增评价列 -->
          <el-table-column label="评价" prop="evaluation">
            <template #default="scope">
              <el-tag
                :type="getTagType(scope.row.evaluation)"
                disable-transitions
          ...
          <el-table-column label="操作" width="130px">
            <template #default="scope">
              ...
              <el-popconfirm
                title="确认删除？"
                @confirm="handleDelete(scope.row.dormRoomId)"
              >
                <template #reference>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <el-form-item label="评价" prop="evaluation">
                <el-select v-model="form.evaluation" placeholder="请选择评价">
          ...
          <!-- 学生详情弹窗 -->
          <el-dialog v-model="studentDetailDialog" title="学生信息" width="30%">
            <el-form
            ...
            >
              ...
              <el-form-item label="手机号：" prop="phoneNum">
                <template #default="scope">
                  <span>{{ studentDetail.phoneNum }}</span>
                </template>
              </el-form-item>
            ...
            <template #footer>
              <span class="dialog-footer">
                <el-button type="primary" @click="closeStudentDetail"
                  >确 定</el-button
                >
              </span>
            </template>
